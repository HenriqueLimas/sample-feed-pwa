export default function init(global) {
  ...
  if (!isCustomElementsLoaded) {
    ...
    newScript.onerror = () => console.error('FailedLoading: Custom elements polyfill!')
    global.document.currentScript.parentNode.insertBefore(newScript, global.document.currentScript)
  } else {
    runWhenLoadedFns()
  }
