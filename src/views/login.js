    ...
    ${Head(ctx)}
      <section class="view login-view" data-view-position="bottom">
        ...
        <div class="view__content">
          <div class="login-view__social">
            <a href="#" class="login-view__social-button login-view__social--twitter">
             ...
             <span class="login-view__social-description">Continue with Twitter</span>
            </a>
          </div>

          <div class="login-view__social">
            <a href="#" class="login-view__social-button login-view__social--facebook">
              ...
              <span class="login-view__social-description">Continue with Facebook</span>
            </a>
          </div>

          <div class="login-view__social">
            <a href="#" class="login-view__social-button login-view__social--google">
              ...
              <span class="login-view__social-description">Continue with Google</span>
            </a>
          </div>

          <div class="login-view__email">
            <a href="#" class="login-view__email-link">Sign in or sign up with email</a>
          </div>
        </div>
        <div class="view__footer">
          <div class="login-view__terms">By continuing, you agree to our Terms and Privacy Policy</div>
        </div>
      </section>
    ${Scripts(ctx)}
  `;
