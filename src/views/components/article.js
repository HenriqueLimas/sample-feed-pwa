...
const Article = (ctx) => `
  <article class="card articleItem js-articleItem">
    ...
    <div class="articleItem__image-container">
      <a class="articleItem__image js-articleItem__image" href="${ctx.article.url || ''}" style="background-image: url(${ctx.article.image});"></a>
    </div>
  </article>
`
